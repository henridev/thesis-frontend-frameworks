...
function Login(props) {
  ...
  function handleLogin(e) {
    ...
    _authorization.default.login(profileInfo.email, profileInfo.password).then(function (user) {
      props.setUser(user);
  ...
  }, "Please sign in"), /*#__PURE__*/_react.default.createElement("input", {
    name: "email",
    type: "email",
  ...
  }, "Sign in"), /*#__PURE__*/_react.default.createElement("span", {
    onClick: function onClick() {
      return props.setIsLogin(false);
    },
